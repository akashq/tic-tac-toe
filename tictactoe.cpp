...
void gboxcalculationp1()
{
	...
	/*
	//codes for testing pousposes starts
	for(int i=0;i<9;i++)
	{
		cout<<endl;
		cout<<"rows ";
	...
	//codes for testing pousposesends
	*/
